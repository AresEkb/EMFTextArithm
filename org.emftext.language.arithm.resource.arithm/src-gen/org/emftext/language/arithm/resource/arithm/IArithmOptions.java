 ...
 */
public interface IArithmOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation().getResourcePostProcessorProviderOptionKey();
