...
/**
 * ArithmLayoutInformation objects are used to store layout information that is
 ...
 * ArithmLayoutInformations are aggregated in LayoutInformationAdapters. One
 * ArithmLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class ArithmLayoutInformation {
	 ...
	 */
	private final org.emftext.language.arithm.resource.arithm.grammar.ArithmSyntaxElement syntaxElement;
	...
	public ArithmLayoutInformation(org.emftext.language.arithm.resource.arithm.grammar.ArithmSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.emftext.language.arithm.resource.arithm.grammar.ArithmSyntaxElement getSyntaxElement() {
