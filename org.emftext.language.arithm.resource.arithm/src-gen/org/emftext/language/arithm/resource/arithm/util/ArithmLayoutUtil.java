...
public class ArithmLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.emftext.language.arithm.resource.arithm.grammar.ArithmSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.emftext.language.arithm.resource.arithm.grammar.ArithmGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.emftext.language.arithm.resource.arithm.grammar.ArithmSyntaxElement syntaxElement = org.emftext.language.arithm.resource.arithm.grammar.ArithmGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.emftext.language.arithm.resource.arithm.grammar.ArithmPlaceholder) {
			org.emftext.language.arithm.resource.arithm.grammar.ArithmPlaceholder placeholder = (org.emftext.language.arithm.resource.arithm.grammar.ArithmPlaceholder) syntaxElement;
			org.emftext.language.arithm.resource.arithm.IArithmTokenResolver tokenResolver = new org.emftext.language.arithm.resource.arithm.mopp.ArithmTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.emftext.language.arithm.resource.arithm.IArithmTokenResolveResult result = new org.emftext.language.arithm.resource.arithm.mopp.ArithmTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
