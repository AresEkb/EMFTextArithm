 ...
 */
public class ArithmLaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new org.emftext.language.arithm.resource.arithm.launch.ArithmLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
