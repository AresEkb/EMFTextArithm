...
public class ArithmStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.emftext.language.arithm.resource.arithm.IArithmFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.emftext.language.arithm.resource.arithm.IArithmFunction1<String, T> toStringFunction) {
