...
/**
 * A ArithmLayoutInformationAdapter is used to store layout information that is
 ...
 * ArithmLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class ArithmLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation>();
	...
	public java.util.List<org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.language.arithm.resource.arithm.mopp.ArithmLayoutInformation layoutInformation) {
