 ...
 * 
 */
package org.emftext.language.arithm.resource.arithm.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class ArithmLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.emftext.language.arithm.resource.arithm.util.AbstractArithmInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.emftext.language.arithm.resource.arithm.util.AbstractArithmInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.emftext.language.arithm.resource.arithm.debug.ArithmDebuggableInterpreter<ResultType, ContextType> interpreter = new org.emftext.language.arithm.resource.arithm.debug.ArithmDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.emftext.language.arithm.resource.arithm.debug.ArithmDebuggerListener<ResultType, ContextType> debugListener = new org.emftext.language.arithm.resource.arithm.debug.ArithmDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.emftext.language.arithm.resource.arithm.debug.ArithmDebugProcess process = new org.emftext.language.arithm.resource.arithm.debug.ArithmDebugProcess(launch);
		launch.addDebugTarget(new org.emftext.language.arithm.resource.arithm.debug.ArithmDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.emftext.language.arithm.resource.arithm.launch.ArithmLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.emftext.language.arithm.resource.arithm.util.ArithmResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.emftext.language.arithm.resource.arithm.mopp.ArithmPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
