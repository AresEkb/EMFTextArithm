 ...
 * resolver
 */
public interface IArithmReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends org.emftext.language.arithm.resource.arithm.IArithmConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.emftext.language.arithm.resource.arithm.IArithmReferenceResolveResult<ReferenceType> result);
