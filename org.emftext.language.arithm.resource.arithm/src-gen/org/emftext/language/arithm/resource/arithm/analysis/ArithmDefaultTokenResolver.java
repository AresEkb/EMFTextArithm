 ...
 */
public class ArithmDefaultTokenResolver implements org.emftext.language.arithm.resource.arithm.IArithmTokenResolver {
	 ...
	 */
	public ArithmDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public ArithmDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.arithm.resource.arithm.IArithmTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.arithm.resource.arithm.grammar.ArithmGrammarInformationProvider.INSTANCE.getKeywords()) {
