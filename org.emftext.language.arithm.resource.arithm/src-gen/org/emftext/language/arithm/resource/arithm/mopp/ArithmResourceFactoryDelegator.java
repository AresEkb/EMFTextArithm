...
public class ArithmResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public ArithmResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.emftext.language.arithm.resource.arithm.util.ArithmRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.emftext.language.arithm.resource.arithm.util.ArithmEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.emftext.language.arithm.resource.arithm.mopp.ArithmResourceFactory());
		}
	}
