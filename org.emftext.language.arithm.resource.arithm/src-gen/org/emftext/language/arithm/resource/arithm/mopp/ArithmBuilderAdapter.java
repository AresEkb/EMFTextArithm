...
public class ArithmBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.emftext.language.arithm.resource.arithm.builder";
	
	private org.emftext.language.arithm.resource.arithm.IArithmBuilder defaultBuilder = new org.emftext.language.arithm.resource.arithm.mopp.ArithmBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.emftext.language.arithm.resource.arithm.IArithmBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.emftext.language.arithm.resource.arithm.mopp.ArithmResource customResource = (org.emftext.language.arithm.resource.arithm.mopp.ArithmResource) resourceSet.getResource(uri, true);
			new org.emftext.language.arithm.resource.arithm.mopp.ArithmMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.emftext.language.arithm.resource.arithm.IArithmBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.emftext.language.arithm.resource.arithm.mopp.ArithmMarkerHelper().getMarkerID(org.emftext.language.arithm.resource.arithm.ArithmEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.emftext.language.arithm.resource.arithm.mopp.ArithmTaskItemBuilder taskItemBuilder = new org.emftext.language.arithm.resource.arithm.mopp.ArithmTaskItemBuilder();
		new org.emftext.language.arithm.resource.arithm.mopp.ArithmMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation().getSyntaxName())) {
