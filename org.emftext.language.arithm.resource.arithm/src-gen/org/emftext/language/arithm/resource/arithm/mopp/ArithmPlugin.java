 ...
 */
public class ArithmPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.arithm.resource.arithm";
	/**
	...
	private static ArithmPlugin plugin;
	...
	public static ArithmPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, ArithmPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, ArithmPlugin.PLUGIN_ID, message);
		}
		final ArithmPlugin pluginInstance = ArithmPlugin.getDefault();
