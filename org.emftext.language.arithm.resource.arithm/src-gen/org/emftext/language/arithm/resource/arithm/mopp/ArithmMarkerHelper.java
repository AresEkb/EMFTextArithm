 ...
 * contains
 * <code>org.emftext.language.arithm.resource.arithm.IArithmTextDiagnostic</code>s
 * it uses the more precise information of this extended diagnostic type.
 */
public class ArithmMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.emftext.language.arithm.resource.arithm.mopp.ArithmPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.language.arithm.resource.arithm.IArithmCommand<Object>> commands = new java.util.ArrayList<org.emftext.language.arithm.resource.arithm.IArithmCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.emftext.language.arithm.resource.arithm.IArithmCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.emftext.language.arithm.resource.arithm.IArithmCommand<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.language.arithm.resource.arithm.IArithmCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.emftext.language.arithm.resource.arithm.IArithmCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.arithm.resource.arithm.IArithmTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.language.arithm.resource.arithm.IArithmTextDiagnostic diagnostic) {
		final org.emftext.language.arithm.resource.arithm.IArithmProblem problem = diagnostic.getProblem();
		org.emftext.language.arithm.resource.arithm.ArithmEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.language.arithm.resource.arithm.IArithmCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.language.arithm.resource.arithm.ArithmEProblemSeverity.ERROR) {
					...
					org.emftext.language.arithm.resource.arithm.IArithmTextDiagnostic textDiagnostic = (org.emftext.language.arithm.resource.arithm.IArithmTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.language.arithm.resource.arithm.mopp.ArithmResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.language.arithm.resource.arithm.mopp.ArithmResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.language.arithm.resource.arithm.IArithmQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.language.arithm.resource.arithm.util.ArithmStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.language.arithm.resource.arithm.ArithmEProblemType nextType : org.emftext.language.arithm.resource.arithm.ArithmEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.arithm.resource.arithm.ArithmEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.language.arithm.resource.arithm.ArithmEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.emftext.language.arithm.resource.arithm.ArithmEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.emftext.language.arithm.resource.arithm.util.ArithmRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.emftext.language.arithm.resource.arithm.IArithmCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.emftext.language.arithm.resource.arithm.mopp.ArithmPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
