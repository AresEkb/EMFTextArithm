 ...
 */
public class ArithmHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public ArithmHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.arithm.resource.arithm.mopp.ArithmPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
