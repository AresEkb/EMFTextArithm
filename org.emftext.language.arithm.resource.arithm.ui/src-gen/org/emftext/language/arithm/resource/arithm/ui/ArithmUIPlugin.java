 ...
 */
public class ArithmUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.arithm.resource.arithm.ui";
	public static final String EDITOR_ID = "org.emftext.language.arithm.resource.arithm.ui.ArithmEditor";
	...
	private static ArithmUIPlugin plugin;
	
	public ArithmUIPlugin() {
		super();
	}
	...
	public static ArithmUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ArithmUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ArithmUIPlugin.PLUGIN_ID, message);
		}
		final ArithmUIPlugin pluginInstance = ArithmUIPlugin.getDefault();
