 ...
 */
public class ArithmBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.arithm.resource.arithm.IArithmTextResource resource, final org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.language.arithm.resource.arithm.IArithmTextResource resource, final org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.arithm.resource.arithm.IArithmTextResource resource, final org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.language.arithm.resource.arithm.mopp.ArithmResource) {
							org.emftext.language.arithm.resource.arithm.mopp.ArithmResource concreteResource = (org.emftext.language.arithm.resource.arithm.mopp.ArithmResource) resource;
