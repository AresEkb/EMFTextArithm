 ...
 */
public class ArithmHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.emftext.language.arithm.resource.arithm.ui.ArithmPositionHelper positionHelper = new org.emftext.language.arithm.resource.arithm.ui.ArithmPositionHelper();
	...
	private org.emftext.language.arithm.resource.arithm.ui.ArithmTokenScanner scanner;
	...
	private org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.emftext.language.arithm.resource.arithm.ui.ArithmOccurrence occurrence;
	private org.emftext.language.arithm.resource.arithm.ui.ArithmBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.arithm.resource.arithm.IArithmBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public ArithmHighlighting(org.emftext.language.arithm.resource.arithm.IArithmTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.arithm.resource.arithm.ui.ArithmColorManager colorManager, org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.arithm.resource.arithm.ui.ArithmTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.arithm.resource.arithm.ui.ArithmOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.arithm.resource.arithm.ui.ArithmBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.arithm.resource.arithm.ui.ArithmPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.arithm.resource.arithm.ui.ArithmPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.language.arithm.resource.arithm.ui.ArithmPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.arithm.resource.arithm.ui.ArithmPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.arithm.resource.arithm.ui.ArithmPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.arithm.resource.arithm.ui.ArithmEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
