 ...
 * olInput</code>.
 */
public class ArithmDocBrowserInformationControlInput {
	
	private final ArithmDocBrowserInformationControlInput fPrevious;
	private ArithmDocBrowserInformationControlInput fNext;
	 ...
	 */
	public ArithmDocBrowserInformationControlInput(ArithmDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public ArithmDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public ArithmDocBrowserInformationControlInput getNext() {
		return fNext;
	}
