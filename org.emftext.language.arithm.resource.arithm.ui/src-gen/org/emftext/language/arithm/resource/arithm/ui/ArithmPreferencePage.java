 ...
 */
public class ArithmPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.getDefault().getPreferenceStore());
		setDescription("Arithm Text Editor Preferences");
	}
