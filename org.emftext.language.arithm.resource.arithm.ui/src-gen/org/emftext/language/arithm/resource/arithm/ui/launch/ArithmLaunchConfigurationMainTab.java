 ...
 * 
 */
package org.emftext.language.arithm.resource.arithm.ui.launch;
 ...
 * class.
 */
public class ArithmLaunchConfigurationMainTab extends org.eclipse.debug.ui.AbstractLaunchConfigurationTab {
	...
	public void initializeFrom(org.eclipse.debug.core.ILaunchConfiguration configuration) {
		try {
			uriText.setText(configuration.getAttribute(org.emftext.language.arithm.resource.arithm.launch.ArithmLaunchConfigurationDelegate.ATTR_RESOURCE_URI, ""));
			// more initialization code can be added here
		} catch (org.eclipse.core.runtime.CoreException e) {
			org.emftext.language.arithm.resource.arithm.mopp.ArithmPlugin.logError("Can't initialize launch configuration tab.", e);
		}
	}
	
	public void performApply(org.eclipse.debug.core.ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(org.emftext.language.arithm.resource.arithm.launch.ArithmLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uriText.getText());
	}
	...
	public org.eclipse.swt.graphics.Image getImage() {
		return org.emftext.language.arithm.resource.arithm.ui.ArithmImageProvider.INSTANCE.getImage("icons/launch_tab_main_icon.gif");
	}
	...
	protected void handleBrowseWorkspace() {
		...
		dialog.addFilter(new org.eclipse.jface.viewers.ViewerFilter() {
			...
			public boolean select(org.eclipse.jface.viewers.Viewer viewer, Object parentElement, Object element) {
				if (element instanceof org.eclipse.core.resources.IFile) {
					...
					return file.getFileExtension().equals(new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation().getSyntaxName());
				}
				return true;
			}
		});
		...
		dialog.setValidator(new org.eclipse.ui.dialogs.ISelectionStatusValidator() {
			public org.eclipse.core.runtime.IStatus validate(Object[] selection) {
				if (selection.length > 0 && selection[0] instanceof org.eclipse.core.resources.IFile)				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.OK, org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.OK, "", null);
				
				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.ERROR, "", null);
			}
		});
