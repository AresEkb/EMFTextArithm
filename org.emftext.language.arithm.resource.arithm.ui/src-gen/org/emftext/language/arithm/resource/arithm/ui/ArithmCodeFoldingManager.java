 ...
 */
public class ArithmCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.arithm.resource.arithm.IArithmBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.arithm.resource.arithm.ui.ArithmEditor) {
				org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor = (org.emftext.language.arithm.resource.arithm.ui.ArithmEditor) workbenchPart;
	...
	protected org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor;
	 ...
	 */
	public ArithmCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.arithm.resource.arithm.ui.ArithmEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.arithm.resource.arithm.IArithmTextResource textResource = (org.emftext.language.arithm.resource.arithm.IArithmTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
