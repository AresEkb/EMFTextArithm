...
public class ArithmPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation().getSyntaxName());
	}
