...
/**
 * A text editor for 'arithm' models.
 * <p>
 * This editor has id
 * <code>org.emftext.language.arithm.resource.arithm.ui.ArithmEditor</code>
 * The editor's context menu has id
 * <code>org.emftext.language.arithm.resource.arithm.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.emftext.language.arithm.resource.arithm.EditorRuler</code>.
 * </p>
 */
public class ArithmEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.arithm.resource.arithm.IArithmResourceProvider, org.emftext.language.arithm.resource.arithm.ui.IArithmBracketHandlerProvider, org.emftext.language.arithm.resource.arithm.ui.IArithmAnnotationModelProvider {
	
	private org.emftext.language.arithm.resource.arithm.ui.ArithmHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.arithm.resource.arithm.ui.ArithmCodeFoldingManager codeFoldingManager;
	private org.emftext.language.arithm.resource.arithm.ui.ArithmBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.arithm.resource.arithm.ui.ArithmBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.arithm.resource.arithm.IArithmBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.arithm.resource.arithm.IArithmBackgroundParsingListener>();
	private org.emftext.language.arithm.resource.arithm.ui.ArithmColorManager colorManager = new org.emftext.language.arithm.resource.arithm.ui.ArithmColorManager();
	private org.emftext.language.arithm.resource.arithm.ui.ArithmOutlinePage outlinePage;
	...
	private org.emftext.language.arithm.resource.arithm.ui.ArithmPropertySheetPage propertySheetPage;
	...
	private org.emftext.language.arithm.resource.arithm.ui.IArithmBracketHandler bracketHandler;
	...
	public ArithmEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.arithm.resource.arithm.ui.ArithmSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), ArithmEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.arithm.resource.arithm.IArithmTextResource currentResource = getResource();
				...
				org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.arithm.resource.arithm.EditorContext");
		setRulerContextMenuId("org.emftext.language.arithm.resource.arithm.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.arithm.resource.arithm.ui.ArithmHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.arithm.resource.arithm.ui.ArithmCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.arithm.resource.arithm.mopp.ArithmNature.activate(inputFile.getProject());
		...
		org.emftext.language.arithm.resource.arithm.IArithmTextResource loadedResource = (org.emftext.language.arithm.resource.arithm.IArithmTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.arithm.resource.arithm.IArithmTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.arithm.resource.arithm.IArithmTextResource) {
					setResource((org.emftext.language.arithm.resource.arithm.IArithmTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the ArithmEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.arithm.resource.arithm.IArithmTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.arithm.resource.arithm.ui.ArithmOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.arithm.resource.arithm.ui.ArithmPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.arithm.resource.arithm.IArithmTextResource textResource = (org.emftext.language.arithm.resource.arithm.IArithmTextResource) element.eResource();
			...
			org.emftext.language.arithm.resource.arithm.IArithmTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.arithm.resource.arithm.IArithmTextToken token = lexer.getNextToken();
			...
			org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!ArithmEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.arithm.resource.arithm.IArithmBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.arithm.resource.arithm.IArithmBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.arithm.resource.arithm.ui.IArithmBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.arithm.resource.arithm.ui.IArithmBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.emftext.language.arithm.resource.arithm.IArithmTextResource)) {
					return false;
				}
				org.emftext.language.arithm.resource.arithm.IArithmTextResource textResource = (org.emftext.language.arithm.resource.arithm.IArithmTextResource) resource;
				org.emftext.language.arithm.resource.arithm.IArithmLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
