 ...
 * @since 3.2
 */
public class ArithmBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput fInput;
	 ...
	 */
	public ArithmBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public ArithmBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public ArithmBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput) input;
		...
		org.emftext.language.arithm.resource.arithm.ui.ArithmHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.arithm.resource.arithm.ui.ArithmHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput getInput() {
		return fInput;
	}
