 ...
 */
public class ArithmSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.emftext.language.arithm.resource.arithm.ui.ArithmQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public ArithmSourceViewerConfiguration(org.emftext.language.arithm.resource.arithm.IArithmResourceProvider resourceProvider, org.emftext.language.arithm.resource.arithm.ui.IArithmAnnotationModelProvider annotationModelProvider, org.emftext.language.arithm.resource.arithm.ui.IArithmBracketHandlerProvider bracketHandlerProvider, org.emftext.language.arithm.resource.arithm.ui.ArithmColorManager colorManager) {
		super(org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.emftext.language.arithm.resource.arithm.ui.ArithmCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.emftext.language.arithm.resource.arithm.ui.ArithmTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.language.arithm.resource.arithm.ui.ArithmTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.emftext.language.arithm.resource.arithm.ui.ArithmHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.emftext.language.arithm.resource.arithm.ui.ArithmQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.emftext.language.arithm.resource.arithm.ui.ArithmIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
