...
public class ArithmBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.arithm.resource.arithm.IArithmBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.arithm.resource.arithm.IArithmBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.arithm.resource.arithm.ui.IArithmBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.arithm.resource.arithm.IArithmBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public ArithmBracketSet(org.emftext.language.arithm.resource.arithm.ui.ArithmEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.arithm.resource.arithm.IArithmBracketPair>();
	 ...
	 */
	public org.emftext.language.arithm.resource.arithm.IArithmBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.arithm.resource.arithm.IArithmBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.arithm.resource.arithm.IArithmBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.arithm.resource.arithm.IArithmBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.arithm.resource.arithm.ui.ArithmPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.arithm.resource.arithm.IArithmBracketPair remove(String opening, String closing) {
		for (org.emftext.language.arithm.resource.arithm.IArithmBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.arithm.resource.arithm.IArithmBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.arithm.resource.arithm.ui.ArithmPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.arithm.resource.arithm.ui.ArithmPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
