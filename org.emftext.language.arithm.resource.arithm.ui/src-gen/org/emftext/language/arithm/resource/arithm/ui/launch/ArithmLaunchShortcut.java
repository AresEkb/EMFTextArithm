 ...
 */
public class ArithmLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.emftext.language.arithm.resource.arithm.launch.ArithmLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.emftext.language.arithm.resource.arithm.mopp.ArithmPlugin.logError("Exception while launching selection", e);
		}
	}
