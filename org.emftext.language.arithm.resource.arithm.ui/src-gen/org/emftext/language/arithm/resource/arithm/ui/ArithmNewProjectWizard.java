 ...
 */
public class ArithmNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.arithm.resource.arithm.ui");
							...
							String natureID = org.emftext.language.arithm.resource.arithm.mopp.ArithmNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.arithm.resource.arithm.mopp.ArithmNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation info = new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.getDefault().getBundle();
