 ...
 */
public class ArithmTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	
	private static final String FONT = org.eclipse.jface.resource.JFaceResources.DIALOG_FONT;
	
	private org.emftext.language.arithm.resource.arithm.IArithmResourceProvider resourceProvider;
	private org.emftext.language.arithm.resource.arithm.IArithmHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.arithm.resource.arithm.ui.ArithmBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.arithm.resource.arithm.ui.ArithmBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput infoInput = (org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.arithm.resource.arithm.ui.ArithmHyperlink hyperlink = new org.emftext.language.arithm.resource.arithm.ui.ArithmHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.arithm.resource.arithm.ui.ArithmBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.arithm.resource.arithm.ui.ArithmBrowserInformationControl iControl = new org.emftext.language.arithm.resource.arithm.ui.ArithmBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput) {
							org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput input = (org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.arithm.resource.arithm.ui.ArithmBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.arithm.resource.arithm.ui.ArithmBrowserInformationControl iControl = new org.emftext.language.arithm.resource.arithm.ui.ArithmBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public ArithmTextHover(org.emftext.language.arithm.resource.arithm.IArithmResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.arithm.resource.arithm.ui.ArithmUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.arithm.resource.arithm.IArithmTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.arithm.resource.arithm.ui.ArithmHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.arithm.resource.arithm.ui.ArithmHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.arithm.resource.arithm.ui.ArithmHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.arithm.resource.arithm.ui.ArithmTextHover.getStyleSheet());
			org.emftext.language.arithm.resource.arithm.ui.ArithmHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.arithm.resource.arithm.ui.ArithmDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.language.arithm.resource.arithm.ui.ArithmHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.arithm.resource.arithm.ui.ArithmUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.arithm.resource.arithm.util.ArithmStreamUtil.getContent(styleSheetURL.openStream());
