 ...
 */
public class ArithmNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public ArithmNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new arithm file");
