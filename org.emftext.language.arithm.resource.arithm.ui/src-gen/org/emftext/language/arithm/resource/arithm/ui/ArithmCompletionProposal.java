 ...
 */
public class ArithmCompletionProposal implements java.lang.Comparable<ArithmCompletionProposal> {
	 ...
	 */
	private org.emftext.language.arithm.resource.arithm.mopp.ArithmExpectedTerminal expectedTerminal;
	...
	public ArithmCompletionProposal(org.emftext.language.arithm.resource.arithm.mopp.ArithmExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public org.emftext.language.arithm.resource.arithm.mopp.ArithmExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof ArithmCompletionProposal) {
			ArithmCompletionProposal other = (ArithmCompletionProposal) object;
	...
	public int compareTo(ArithmCompletionProposal object) {
		if (object instanceof ArithmCompletionProposal) {
			ArithmCompletionProposal other = (ArithmCompletionProposal) object;
