 ...
 * a specified depth.
 */
public class ArithmOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public ArithmOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.language.arithm.resource.arithm.util.ArithmStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.arithm.resource.arithm.ui.ArithmEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.arithm.resource.arithm.mopp.ArithmPlugin.logError("Exception while refreshing outline view", e);
		}
	}
