 ...
 */
public class ArithmSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public ArithmSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation metaInformation = new org.emftext.language.arithm.resource.arithm.mopp.ArithmMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.arithm.resource.arithm.ui.ArithmSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.arithm.resource.arithm.ui.ArithmPixelConverter pixelConverter = new org.emftext.language.arithm.resource.arithm.ui.ArithmPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.arithm.resource.arithm.ui.ArithmEditor) {
			org.emftext.language.arithm.resource.arithm.ui.ArithmEditor emfTextEditor = (org.emftext.language.arithm.resource.arithm.ui.ArithmEditor) editor;
